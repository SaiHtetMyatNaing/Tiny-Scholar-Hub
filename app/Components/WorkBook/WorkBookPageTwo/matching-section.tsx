    ...
    <Box className="z-[2000] flex flex-col gap-4 justify-between cursor-pointer">
...

        {
            array.map((item)=> {
                return (
                    <Box
                    className='flex items-center justify-center w-24 h-20 text-center border-[1px] border-black rounded-md shadow-md' key={item}>
                        <span>{item}</span>
                    </Box>
                )
            })
        ...
        <Reorder.Group 
         className='flex flex-col gap-2 ' axis='y' values={array2} onReorder={setArray2}>

        {
            array2.map((item)=> {
                return (
                    ...
                    value={item}
                    className='flex items-center justify-center w-24 h-20 text-center bg-white border-[1px] border-black  rounded-md shadow-md' key={item}>
                        <span>{item}</span>
                    </Reorder.Item>
                )
            })
